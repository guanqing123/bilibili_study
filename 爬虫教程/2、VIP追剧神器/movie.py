...
class VIPVideoApp:
    ...
    def create_widgets(self):
        ...
        # 按钮控件
        button_movie1 = tkinter.Button(self.root, text='爱奇艺', command=open_iqy)
        button_movie1.place(x=25, y=80, width=80, height=40)

        button_movie2 = tkinter.Button(self.root, text='腾讯视频', command=open_tx)
        button_movie2.place(x=125, y=80, width=80, height=40)

        button_movie3 = tkinter.Button(self.root, text='优酷视频', command=open_yq)
